...
[CmdletBinding(DefaultParameterSetName = 'InstallServerAndClient')]
param (
    [Parameter(Mandatory = $true, ParameterSetName = 'InstallServerOnly')]
    [switch]
    $ServerOnly,

    [Parameter(Mandatory = $true, ParameterSetName = 'InstallClientOnly')]
    [switch]
    $ClientOnly,
...
# The immediate child items of the "$SSHProgramDataPath" directory.

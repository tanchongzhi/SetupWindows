...
if ($osVersion.Major -ge 10 -and $osVersion.Build -ge 22000) {
    Write-Host 'Folder Options : General : Privacy : Show cloud files in Quick Access : Disabled'
...
if ($osVersion.Major -ge 10) {
    Write-Host 'Folder Options : View : Files and Folders : Show sync provider notifications : Disabled'
